                ...
                <table>
                  <tbody>
                    <tr>
                      ...
                      <td className="value">{selectedPenduduk.NIK}</td>
                    </tr>
                    <tr>
                      <td className="label">Nama</td>
                      <td className="colon">:</td>
                      <td className="value">{selectedPenduduk.nama}</td>
                    </tr>
                    <tr>
                      <td className="label">Tempat/Tgl Lahir</td>
                      <td className="colon">:</td>
                      <td className="value">{selectedPenduduk.ttl}</td>
                    </tr>
                    <tr>
                      <td className="label">Jenis Kelamin</td>
                      <td className="colon">:</td>
                      <td className="value">
                        {selectedPenduduk.jk === "L"
                          ? "Laki - Laki"
                          : "Perempuan"}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="colon">:</td>
                      <td className="value">
                        {selectedPenduduk.golongan_darah}
                      </td>
                    </tr>
                    <tr>
                      <td className="label">Alamat</td>
                      <td className="colon">:</td>
                      <td className="value">{selectedPenduduk.alamat}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="colon">:</td>
                      <td className="value">{selectedPenduduk.pendidikan}</td>
                    </tr>
                    <tr>
                      <td className="label">Pekerjaan</td>
                      <td className="colon">:</td>
                      <td className="value">{selectedPenduduk.pekerjaan}</td>
                    </tr>
                    <tr>
                      <td className="label">Kewarganegaraan</td>
                      <td className="colon">:</td>
                      <td className="value">
                        {selectedPenduduk.kewarganegaraan}
                      </td>
                    </tr>
                  </tbody>
                </table>
