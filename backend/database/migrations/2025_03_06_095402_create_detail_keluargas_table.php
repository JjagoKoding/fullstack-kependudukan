...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tb_detail_keluarga', function (Blueprint $table) {
            ...
            $table->foreign('NOKK')->references('NOKK')->on('tb_keluarga')->cascadeOnDelete();
            $table->foreign('NIK')->references('NIK')->on('tb_penduduk')->cascadeOnDelete();
            $table->foreign('nik_ayah')->references('NIK')->on('tb_penduduk')->nullOnDelete();
            $table->foreign('nik_ibu')->references('NIK')->on('tb_penduduk')->nullOnDelete();
        });
    }
